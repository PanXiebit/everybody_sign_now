...
class MaskPredict(object):
    ...
    def generate_separate(self, model, tag_name, trg_tokens, word_feat, word_mask, points_mask, pad_idx, mask_idx):
        """
        """
        ...
        decoder_output = model.decoder(
                ...
                window_size=self.token_num, 
                tag_name=tag_name)
        trg_tokens, token_probs, _ = generate_step_with_prob(decoder_output)
