...
from models.pose_vqvae_vit_model_mcodebooks import PoseVitVQVAE
...
vqvae_path = "logs/SeqLen_{16}_TemDs_{1}_AttenType_{spatial-temporal-joint}_DecoderType_{divided-unshare}_ncodes_1024_mcodebooks/lightning_logs/version_1/checkpoints/epoch=12-step=38973.ckpt"
...
token_num = 5
with torch.no_grad():
    with open("analysis/text2point_tokens_mcodebooks_{}.txt".format(mode), "w") as f:
